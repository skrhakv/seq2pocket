...
#SBATCH --output=/home/skrhakv/cryptoshow-analysis/src/pLM-training/output.txt       # stdout and stderr output file
...
cd /home/skrhakv/cryptoshow-analysis/src/pLM-training
