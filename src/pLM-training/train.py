...
val_dataset = finetuning_utils.process_sequence_dataset(F'{DATA_DIRECTORY}/data-extraction/ligysis_without_unobserved.csv', tokenizer) 
...
OUTPUT_PATH = f'{DATA_DIRECTORY}/models/gbs-model-enhanced-scPDB-filtered.pt'
